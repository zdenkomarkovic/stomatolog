            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                <div className="text-center p-6 bg-primary/5 rounded-2xl">
                  ...
                  <p className="text-sm text-gray-600">{t.home.statsExperience}</p>
                </div>
                <div className="text-center p-6 bg-primary/5 rounded-2xl">
                  <p className="text-4xl font-bold text-primary mb-2">2000+</p>
                  <p className="text-sm text-gray-600">{t.home.statsPatients}</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp} className="lg:order-2">
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/WhatsApp Image 2025-12-13 at 17.30.12 (1).jpeg"
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }} className="lg:order-1">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6 flex items-center gap-3">
